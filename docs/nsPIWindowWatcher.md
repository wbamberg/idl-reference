...
<code> A window has been created. Add it to our list.  
...
<code> A window has been closed. Remove it from our list.  
...
<code> Like the public interface's open(), but can handle openDialog-style  
